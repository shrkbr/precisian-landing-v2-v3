        ...
        <div className="max-w-4xl">
          ...
          <ContentSection title="Funcionalidades Principais">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <FeatureCard icon={ArrowLeftRight} title="Integração Multi-Plataforma" description="Conectamos ERPs, CRMs, plataformas de e-commerce e sistemas de PDV às plataformas de mídia como Google, Meta, TikTok e mais." />
          ...
          <ContentSection title="Capacidades Técnicas">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              <FeatureCard icon={Layers} title="APIs Conversions" description="Integração nativa com Google Ads Conversions API, Meta Conversions API, TikTok Events API e outras plataformas." />
              <FeatureCard icon={BarChart3} title="Relatórios de Conciliação" description="Dashboards detalhados mostrando diferenças entre dados de plataforma e vendas reais, com alertas automáticos." />
              <FeatureCard icon={Zap} title="Enhanced Conversions" description="Implementação de Enhanced Conversions para melhorar match rate e qualidade dos dados enviados às plataformas." />
            </div>
          </ContentSection>
        </div>
      </ServicePageLayout>
